<?php 
$user = $conn->query("SELECT * FROM spable_list where id ='".$_settings->userdata('id')."'");
				...
				<form action="" id="manage-user">	
					...
					<div class="row">
						<div class="form-group col-md-6">
							...
							<input type="text" id="fullname" autofocus name="fullname" class="form-control form-control-sm form-control-border" value="<?= isset($shop_name) ? $shop_name : "" ?>" required>
						</div>
						<div class="form-group col-md-6">
							<label for="parentname" class="control-label">Parent Name</label>
							<input type="text" id="parentname" name="parentname" class="form-control form-control-sm form-control-border" value="<?= isset($shop_owner) ? $shop_owner : "" ?>" required>
						</div>
						<div class="form-group col-md-6">
