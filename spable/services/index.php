        ...
        <div class="container-fluid">
			<table class="table table-bordered table-stripped">
				...
				<tbody>
					<?php 
					$i = 1;
						$qry = $conn->query("SELECT * from `service_list` where delete_flag = 0 and `spable_id` = '{$_settings->userdata('id')}' order by `name` asc ");
...
<script>
	$(document).ready(function(){
		...
		$('.view_data').click(function(){
			uni_modal('View Service Details',"services/view_service.php?id="+$(this).attr('data-id'))
		})
		$('.edit_data').click(function(){
			uni_modal('Update Service',"services/manage_service.php?id="+$(this).attr('data-id'))
		})
